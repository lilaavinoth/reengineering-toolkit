...
//        adfafdsf
        ...
        int nField = 0;
        System.out.println("List of all fields in the current class");
        for (Field field : fields) {
            System.out.printf("%d. %s",++nField,field);
            System.out.println();
        }
       // System.out.println("%d. End - all fields of Student class",++nField);
        System.out.println("total number of data fields: " + nField);
    }
